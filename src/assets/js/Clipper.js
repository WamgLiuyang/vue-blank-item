    ...
    window.Clipper = class {
        ...
        * */
        constructor(container, _options){
			...
			// holeSize = 50
            this.coverStartX = (WIDTH - holeSize)/2		//¾ÓÖÐ
            this.coverStartY = (HEIGHT - holeSize)/2		//¾ÓÖÐ
			let img = new Image(), that = this;
			
			img.src = require("../image/choies-box.png");
			img.onload = function(){
				that.coverCtx.drawImage(img, that.coverStartX, that.coverStartY, holeSize, holeSize)
			}
